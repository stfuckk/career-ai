...
from app.schemas.career_test import CareerTestPreviewRead
...
@router.get('/{job_id}/result', response_model=CareerTestPreviewRead)
async def get_ai_job_result(job_id: str, db: AsyncSession = Depends(get_db_session)) -> CareerTestPreviewRead:
